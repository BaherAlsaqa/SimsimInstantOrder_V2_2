...
public abstract class BaseAnncaActivity<CameraId> extends AnncaCameraActivity<CameraId>
    ...
    public void startPreviewActivity(File GalleryImg) {
        if(GalleryImg!=null){
            Intent intent = PreviewActivity.newIntent(this,
                    getMediaAction(), GalleryImg.toString());
            startActivityForResult(intent, REQUEST_PREVIEW_CODE);
        }
       else if (mediaResultBehaviour == AnncaConfiguration.PREVIEW) {
            Intent intent = PreviewActivity.newIntent(this,
