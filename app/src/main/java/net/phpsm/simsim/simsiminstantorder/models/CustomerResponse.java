...
public class CustomerResponse {
    ...
    public CustomerResponse(String status, String error, String token_type, String expires_in, String access_token, String refresh_token, Integer is_validate, String code) {
        this.status = status;
        this.error = error;
