...
public class MyFriendRecommendedList {
    @SerializedName("current_page")
    @Expose
    private Integer currentPage;
    @SerializedName("data")
    @Expose
    private ArrayList<MyFriendsRecommended> data = null;
    ...
    public ArrayList<MyFriendsRecommended> getData() {
        return data;
    }

    public void setData(ArrayList<MyFriendsRecommended> data) {
        this.data = data;
    }
