...
public class MyAdditionAdapter extends RecyclerView.Adapter<MyAdditionAdapter.ViewHolder> {
    List<ProductAdditional> productAdditionalList;
    Context context;
    private OnItemClickListener18 listener1;

    public MyAdditionAdapter(List<ProductAdditional> productAdditionalList, Context context) {
    ...
    @Override
    public void onBindViewHolder(MyAdditionAdapter.ViewHolder holder, int position) {
        ...
        productAdditional.setSelected(-1);
